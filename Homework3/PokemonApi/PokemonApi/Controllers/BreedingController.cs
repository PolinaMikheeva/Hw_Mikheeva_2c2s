...
namespace PokemonApi.Controllers
{
    ...
    public sealed class BreedingController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<BreedingCreateDto>> AddBreeding(BreedingCreateDto breeding)
        {
        ...
        /// <returns></returns>
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateBreeding([FromRoute] int id, BreedingUpdateDto breeding)
        {
