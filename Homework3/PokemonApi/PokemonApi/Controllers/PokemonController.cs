...
namespace PokemonApi.Controllers
{
    ...
    public sealed class PokemonController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Pokemon>> GetById([FromForm] int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<PokemonCreateDto>> AddPokemon([FromForm] PokemonCreateDto pokemon)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdatePokemon([FromForm] int id, [FromForm] PokemonUpdateDto pokemon)
        {
        ...
        /// <returns>Результат выполнения операции</returns>
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeletePokemon([FromForm] int id)
        {
